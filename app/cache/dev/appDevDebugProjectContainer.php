...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'maitre-oeuvre', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MaitreOeuvreBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));
        ...
        $d->addDriver($b, 'MaitreOeuvreBundle\\Entity');
        $d->addDriver($b, 'UserBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('MaitreOeuvreBundle' => 'MaitreOeuvreBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_85e82877f3fba8fa7868308a63016e24ec78e3b3ac12bf5507c9bc3976a33d5d');
     ...
     *
     * @return \UserBundle\Redirection\AfterLoginRedirection
     */
     ...
     *
     * @return \UserBundle\Redirection\AfterLogoutRedirection
     */
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/patron');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/secretaire');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/client');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/artisan');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/chantier');
        ...
        $r->add($m, array(0 => 'ROLE_PATRON'), NULL);
        $r->add($n, array(0 => 'ROLE_SECRETAIRE'), NULL);
        $r->add($o, array(0 => 'ROLE_CLIENT'), NULL);
        $r->add($p, array(0 => 'ROLE_ARTISAN'), NULL);
        $r->add($q, array(0 => 'ROLE_PATRON'), NULL);

        $s = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $t = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $u = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $s, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($s, '/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $w = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $h, $s, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $v, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $w->setRememberMeServices($t);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($r, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $u, 3 => $w, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $t, $g, $a, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $r, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $s, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $s, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MaitreOeuvreBundle/Resources/views'), 'MaitreOeuvre');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MaitreOeuvreBundle' => 'MaitreOeuvreBundle\\MaitreOeuvreBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MaitreOeuvreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MaitreOeuvreBundle'),
                    'namespace' => 'MaitreOeuvreBundle',
                ),
                'UserBundle' => array(
            ...
            'console.command.ids' => array(
                ...
                5 => 'doctrine.fixtures_load_command',
            ),
        );
    }
}
